...
func (a anubhav) area() float64 {
	fmt.Println("fds")
	return 1.
}
func (a anubhav) perimeter() float64 {
	fmt.Println("fds")
	return 1.
}
func main() {
	...
	var t shape = anubhav{company: "mt", age: 22} // we can only use this if anubhav type have all method which are in shape interface as signature
	fmt.Printf("%T\n", t)
